...
function safeLevels(arrayOfLevels) {
    foundLevel = arrayOfLevels.find((level) => {
        const levelInNumber = parseFloat(level.split("").slice(0, 4).join(""));
        return levelInNumber >19.5 && levelInNumber < 23.5;
